...
outputs,     IRI Array, false,    "Array of IRI values of Device Model Output"
|===
...
==== Description
Retrieve a list of DeviceModel
/api/device_models, method=Get
...
==== Description
Retrieve a DeviceModel
/api/device_models/{code}, method=Get
...
==== Description
/api/device_models/{code}, method=Patch
...
/api/device_models/{code}, method=Put
...
/api/device_models/{code}, method=Delete
